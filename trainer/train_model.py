...
data_path = "/data"
in_train_path = os.path.join(data_path, 'input_train.csv')
out_train_path = os.path.join(data_path, 'output_train.csv')
# read data
...
model_path = "/models"
export_path = os.path.join(model_path, "model_svm")
print('Exporting trained model to', export_path)
dump(clf, export_path)
export_path = os.path.join(model_path, "vectorizer")
